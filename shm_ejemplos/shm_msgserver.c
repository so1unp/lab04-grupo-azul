...
int main(int argc, char *argv[]) {
	...
	*/
    ...
    /* requesting the shared segment    --  mmap() 
		addr - If addr is NULL, then the kernel chooses the address at which to create the mapping; 
			  this is the most portable method of creating a new mapping.
		PROT_READ - Data can be read.
		PROT_WRITE - Data can be written.
		MAP_SHARED - Changes are shared (changes the underlying posix object).
	*/    
    ...
    shared_msg->type = 23;
    strcpy(shared_msg->content,"Prueba de shm");
